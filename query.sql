...
# cf) ENGINE=InnoDB	: 트랜잭션 지원(ACID), 외래 키 제약 조건 지원(참조 무결성 보장)
...
CREATE TABLE IF NOT EXISTS `stocks` (
    ...
    INDEX dix_stocks_product_id (product_id)								 # INDEX 제약 조건
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci
  COMMENT = '상품 재고 정보';
