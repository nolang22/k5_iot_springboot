package com.example.k5_iot_springboot.common.contants;
...
public class ApiMappingPattern {
    ...
    public static final class Posts {
        ...
        public static final String TOP_BY_COMMENT = "/top-comments";
    }

    // == 3. 댓글(D_Comment) == //
    /*  RESTful API 설계
            - 현재 구조) 댓글(Comment)가 게시글(Post) 멘티티에 포함 (1 : N의 관계)

            - 족성된 데이터에 대해 하위 리소스 표현을 사용
