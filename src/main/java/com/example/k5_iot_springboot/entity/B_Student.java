...
@Entity
//  DB 테이블과 1:1 매핑, JPA 엔티티임을 선언 (반드시 PK 기본키가 필요)
//      : JPA는 엔티티를 통해 객체와 테이블 간 테이터를 자동 변환(ORM)
...
public class B_Student {
    ...
    // @RequiredArgsConstructor - final 또는 @NonNull 필드를 매개변수로 시용하는 생성자
    private String name;
