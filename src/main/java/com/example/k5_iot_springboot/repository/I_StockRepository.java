...
public interface I_StockRepository extends JpaRepository<I_Stock, Long> {
    ...
    // 비관적 잠금(재고 결함 제어를 위함)
    // : 데이터를 수정하기 전에 해당 데이터에 대한 다른 트랜잭션의 접근을 막ㅇ 데이터의 정합성을 보장!
    // - 읽기 및 쓰기 모두 막는 역할!
