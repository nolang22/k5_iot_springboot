...
/*  === 스프링부트 구조 ===
    ...
    2. 스프링 부트 (Spring Boot)란?
        : 스프링을 쉽고 빠르게 사용할 수 있도록 자원하는 프레임워크 확장판
        - 스프링 부트 스타터 제공 (빌드 & 의존성 관리 최소화)
        - XML 설정 없이 JAVA 코드 기반 설정 기능 (Annotation 기반)
    ...
    1. 서블릿
        ...
        2) 기능/URI 마다 여러 서블릿을 만들거나, 직접 프론트 컨트롤러 패텅(서블릿 1개 + 내부 분기)를 구현
