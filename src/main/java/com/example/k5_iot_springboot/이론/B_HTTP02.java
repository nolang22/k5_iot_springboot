...
/*  cf) 인터넷의 기본 개념
        ...
        2) DNS: 도메인 이름을 IP 주소로 반환 (google.com >>> 172.217.@@@.XXX)
        3) PORT 번호: 하나의 IP 에서 다양한 프로그램 서버를 구분
        ...
        2. HTTP 상태 코드 (Status Code)
            ...
            1) 200 번대
                200 OK: 성공 (요정한 작업 성공 - GET/PUT/DELETE)
                201 Create: 생성 성공 (새로운 데이터 생성 성공 - POST)

            2) 400 번대 - 개발자가 처리해야 하는 문제
