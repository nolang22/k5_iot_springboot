...
/*  === ORM (Object - Relational Mapping) ===
    ...
    - DB으 ㅣㄷ테이블과 애플리케이션의 객체 사이의 주조적 불일치를 해결하는 솔루션
    ...
    1. ORM 특징
        : 객체와 테이블이 1:1로 매핑
        - 객체지향적인 테이터 조작 (SQL 대신 자바 객체 메서드로 CRUD 작업 수행)
    ...
    2. ORM 동작 원리
        ...
        - Field: DB의 열(Column)에 해당되는 필드

    3. JPA (Java Persistence API)
        : ORM 중 하나
        - Java 애플리케이션에서 관계형 DB을 쉽게 다룰 수 있는 ORM 표준 기술

    cf) 영속성 컨텍스트
        : 엔터티의 생명주기를 관리하는 공간
        - DB와의 연결은 유지하면서 엔터티 객체들을 관리
